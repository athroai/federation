...
import { QuizMathValidator, ValidationResult } from './QuizMathValidator';
...
TOTAL ACCURACY IS NON-NEGOTIABLE. Verify EVERY fact, calculation, and answer before finalizing.`;
  ...
  const response = await fetch('https://api.openai.com/v1/chat/completions', {
    ...
    body: JSON.stringify({
      model: 'gpt-4o', // ⚠️ CRITICAL: ALWAYS use GPT-4o (GPT-4.1 Advanced) for ALL quizzes regardless of user tier

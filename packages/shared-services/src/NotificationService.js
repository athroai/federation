...
export class NotificationService {
    ...
    async createSmartStudySchedule(userPreferences) {
        const reminders = [];
    ...
    async sendProgressNotification(data) {
        let title = '';
        let message = '';
    ...
    async handleStudySessionCompleted(sessionData) {
        ...
        const activeReminders = Array.from(this.studyReminders.values()).filter(r => r.isActive && r.recurring && r.subjects?.includes(sessionData.subject));
    ...
    handleStartStudySession(reminder) {
    ...
    async loadUserPreferences() {
        try {
            ...
            if (response.ok) {
                ...
                this.preferences = { ...this.preferences, ...serverPreferences };
            }
        }
        catch (error) {
    ...
    async initializeStudyReminders() {
    ...
    getNextReminderTime(dayName, timeString) {

...
export const NotificationPreferencesComponent: React.FC<NotificationPreferencesProps> = ({
  ...
  return (
    <Box sx={{ maxWidth: 800, mx: 'auto' }}>
      ...
      {/* Success Message Area - Fixed Height to Prevent Layout Shift */}
      <Box sx={{ mt: 3, mb: 2, minHeight: successMessage ? 'auto' : 0, opacity: successMessage ? 1 : 0, transition: 'opacity 0.3s ease' }}>
        <Alert 
          severity="success" 
          sx={{ 
        ...
        >
          {successMessage || 'Placeholder message'}
        </Alert>
      </Box>
